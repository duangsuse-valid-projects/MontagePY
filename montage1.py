...
# == App ==
CmdParamSpacing = RegexType(r":(\-?\d+),(\-?\d+)", lambda t: (int(t[0]), int(t[1])))
...
apg.add_argument("-spacing", metavar=":h,v", type=CmdParamSpacing, default=(0,0), help="horizontal,vertical padding each item")
